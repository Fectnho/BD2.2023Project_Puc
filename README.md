...
<p> 	A Gestão de Dados é de suma importância dentro de uma organização. Os dados são informações que podem ser armazenados e processados e que, se usados da maneira correta, podem criar vantagens competitivas e auxiliar em estratégicas para o sucesso 	organizacional. Uma gestão precisa e adequada ajuda a melhorar toda a eficiência operacional, que vai desde a coleta, passando pelo armazenamento, proteção e o uso propriamente dito desses dados pela organização.  </p>
